...
public partial class Page_Mom_Agenda : System.Web.UI.Page
{
    ...
    protected void BindDropDown()
    {
        ...
        DrpCalendar.DataSource = P.BindCalenderDropdown("CalName", Convert.ToInt32(Session["UserId"]), "",0,"");
    ...
    protected void PopulateEvents()
    {
       ...
       String Date="";
        ...
        Processing P = new Processing();
        drpEvent.DataSource = P.BindCalenderDropdown("Mom Events", Convert.ToInt32(Session["UserId"]), DrpCalendar.SelectedValue, Convert.ToInt32(DrpAcademicYear.SelectedValue), Date);
